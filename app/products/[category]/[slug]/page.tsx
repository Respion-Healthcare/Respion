...
export async function generateMetadata({ params }: any): Promise<Metadata> {
  ...
  return {
   ...
   description: `Buy ${product.name} CPAP machine online in India at the best price with warranty, sleep apnea support and fast delivery from Respion.`,    alternates: {
...
href={`/products/${item.category}/${item.slug}`}
  ...
  <p className="mb-4">
    Buy {product.name} online in India at the best price from Respion. This product is designed for effective respiratory care and is widely used for CPAP therapy and breathing support. It ensures comfort, durability, and reliable performance for long-term use.
  </p>
