...
export async function generateMetadata({ params }: any): Promise<Metadata> {
  ...
  if (slug === "cpap-machine") {
    return {
      title: "CPAP Machine for Sleep Apnea | Buy Online in India - Respion",
      description:
  ...
  return {
    ...
    description: `Buy ${categoryName} online in India at best price from Respion.`,
    alternates: {
      canonical: `https://www.Respion.in/category/${slug}`,
    },
  }
 ...
 return (
  ...
  {slug === "cpap-machine" && (
    <>
      ...
      <p className="mb-4">
        At Respion, we offer high-quality CPAP machines designed for comfort, durability, and long-term therapy. Whether you are starting CPAP treatment or upgrading your device, you will find reliable options here.
      </p>
  ...
  {slug !== "cpap-machine" && (
    <>
      ...
      <p className="mb-4">
        Explore the latest {slug.replace(/-/g, " ")} available in India at the best prices. Respion offers high-quality products with fast delivery.
      </p>
    </>
  )}
