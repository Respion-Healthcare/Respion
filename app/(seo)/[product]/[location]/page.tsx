...
> = {
  india: {
    ...
    intro:
      "Looking to buy a CPAP machine in India? Respion offers the latest CPAP, BiPAP, and oxygen concentrators at the best prices with fast delivery across India.",
    points: [
...
function generateDynamicContent(
  ...
  return {
    ...
    intro: `Looking to buy ${productName} in ${formatted}? Respion offers best prices, fast delivery, and expert support near you.`,
    points: [
    ...
    paragraph: `Respion provides genuine ${productName} in ${formatted} with warranty, installation support, and quick service across all major areas.`,
  }
}
...
export default async function Page({
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <p className="mb-4">
        Respion provides reliable {productName} solutions in{" "}
